...
project = 'masakarimonitors Release Notes'
...
latex_documents = [
    ('index', 'MasakarimonitorsReleaseNotes.tex', 'Masakarimonitors Release'
     'Notes Documentation', 'Masakarimonitors Developers', 'manual'),
]
...
man_pages = [
    ('index', 'Masakarimonitorsreleasenotes', 'Masakarimonitors Release Notes'
     'Documentation', ['Masakarimonitors Developers'], 1)
]
...
texinfo_documents = [
    ('index', 'MasakarimonitorsReleaseNotes', 'Masakarimonitors Release Notes'
     'Documentation', 'Masakarimonitors Developers',
